...
func (m *MockRepository) GetByID(ctx context.Context, id string) (*entity.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) GetByIDs(ctx context.Context, ids []string) ([]*entity.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) ResetPassword(ctx context.Context, email, password string) error {
	m.ctrl.T.Helper()
...
func (mr *MockRepositoryMockRecorder) ResetPassword(ctx, email, password interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ResetPassword", reflect.TypeOf((*MockRepository)(nil).ResetPassword), ctx, email, password)
}

// Update mocks base method.
func (m *MockRepository) Update(ctx context.Context, params *entity.UpdateUserParams) error {
	m.ctrl.T.Helper()
...
func (mr *MockRepositoryMockRecorder) Update(ctx, params interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
