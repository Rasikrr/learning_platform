...
func easyjsonD2b7633eDecodeGithubComRasikrrAssigment2Api(in *jlexer.Lexer, out *EmptySuccessResponse) {
...
func easyjsonD2b7633eEncodeGithubComRasikrrAssigment2Api(out *jwriter.Writer, in EmptySuccessResponse) {
	out.RawByte('{')
	first := true
	_ = first
	{
